...
import image3 from "../../assets/elrufai3.jpg";
import image4 from "../../assets/hack1.jpg";
  ...
  return (
    <div className='w-full lg:min-h-[100vh] dark:bg-black md:min-h-[100vh] min-h-[80vh]  overflow-x-hidden'>
     ...
     <div className='min-h-[100vh] lg:mt-56 md:mt-52 mt-40 w-[100%] flex justify-center items-center relative'>
        <div>
           <h1 className='lg:text-3xl dark:text-white md:text-3xl text-2xl text-center font-semibold mb-2'>OUR FOCUS <span className='text-green'>AREAS</span></h1> 
           <p className='text-sm text-center text-green mb-6'>Empowering Katsina Through ICT</p>
           ...
           <div>
            ...
            <div className='lg:px-10 md:px-10 px-4 mb-6'>
             ...
             <div className='grid dark:bg-black lg:grid-cols-2 grid-cols-1 lg:border-2 md:border-2 border-2  lg:bg-whitegray md:bg-whitegray bg-green border-green rounded-2xl lg:px-10 md:px-10 px-2 lg:py-8 md:py-8 py-2 gap-6'>
             <div>
            ...
            <div className='flex justify-center  relative top-9'><button className='p-5 dark:bg-black bg-whitegray py-6 outline-none rounded-full border-2 border-green'><img src={icon2} data-aos="zoom-in" className='w-10'/></button></div>
             <div className='grid lg:grid-cols-2 grid-cols-1 lg:border-2 md:border-2 dark:border-2 dark:bg-black lg:bg-whitegray md:bg-whitegray bg-green border-green rounded-2xl lg:px-10 md:px-10 px-2 lg:py-8 md:py-8 py-2 gap-6'>
             <div>
