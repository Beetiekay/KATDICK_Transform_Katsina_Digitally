  ...
  return (
    <div className='w-[100%] min-h-[100vh]'>
       ...
       <div className='w-[100%] relative'>
        <div className='dark:bg-black bg-whitegray lg:hidden md:hidden flex w-[100%] h-4 absolute -bottom-1 z-10 '></div>
       <div className='w-full mb-4 lg:overflow-visible md:overflow-visible overflow-x-scroll lg:px-10 md:px-4 px-0 z-0 relative'> 
           <div className='lg:w-full relative md:w-full w-[170vw] p-8 lg:px-10 md:px-8 px-2 lg:gap-10 md:gap-8 gap-4 grid grid-cols-2 group'>
