...
import image from "../../assets/katdickA.gif"
  ...
  return (
    <div className='w-[100%] lg:min-h-[100vh] md:min-h-[80vh] relative overflow-hidden min-h-[70vh]'>
      <img src={image6} className='w-full h-screen opacity-15  absolute object-cover'/>
        ...
        <div className='flex justify-center dark:text-white mb-16'><h1  className=' lg:text-3xl md:text-3xl text-2xl font-semibold lg:text-center md:text-center text-start mb-4'>TO SHAPE THE FUTURE OF<span className='text-green'> KATSINA</span>  TODAY </h1></div>
        ...
        <div >
         ...
         <div className='bg-whitegray dark:bg-black w-full h-6 relative -top-5'></div>
           ...
           <h1 className='font-semibold dark:text-white py-4 pt-16 lg:text-2xl md:text-lg text-sm lg:text-center md:text-center text-start opacity-85'>
            Join Us in Crafting our <Link to={"#"} className=' text-green'>Digital Legacy!</Link>
           </h1>
           </div>
