...
const Cardw = (props) => {
  return (
    <div className='bg-whitegray border border-green dark:bg-green dark:bg-opacity-40 shadow-md py-4 rounded-xl px-4 hover:translate-y-4 duration-700'>
       <div  className='flex justify-center items-center'><img src={props.image} className='rounded-2xl w-64 object-cover '/></div>
