...
import bg from "../../assets/hall4.jpg"
import Tab from './Tab'
...
const Home = () => {
  ...
  return (
    <div className='w-full lg:min-h-[100vh]  md:min-h-[100vh] min-h-[80vh] dark:bg-black bg-whitegray bg-opacity-30 overflow-hidden'>
      ...
      <div className='relative  bg-seagreen dark:bg-gradient-to-tl dark:from-green dark:bg-black from-black dark:bg-opacity-80  bg-opacity-75 '>
