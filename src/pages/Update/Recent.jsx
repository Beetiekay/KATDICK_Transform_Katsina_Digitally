      ...
      <div>
        <div className='absolute z-20'><Navigation/></div>
         ...
         <div className='w-full flex items-center  justify-center'>
           ...
           <div>
           <p data-aos="fade-right" className='font-semibold lg:flex md:flex justify-center hidden dark:text-white lg:py-4 md:py-4 mt-24 mb-8 py-1 pt-16 lg:text-3xl md:text-2xl text-xl text-center opacity-85'>UPDATED KNOWLEDGE  <span className='text-green'> IS POWER</span></p>
           <p data-aos="fade-right" className='font-semibold lg:hidden md:hidden justify-center flex dark:text-white lg:py-4 md:py-4 mt-24 mb-8 py-1 pt-16 lg:text-4xl md:text-2xl text-xl text-center opacity-85'>Updated Knowledge  <span className='text-green'> Is Power</span></p>
                ...
                <img src={down2} className='absolute hidden dark:flex z-0 w-full h-full left-0 right-0 bottom-0  object-cover'/>
                 ...
                 <img src={image3} className='w-full absolute bottom-0 object-cover h-full'/>
                    ...
                    <div className='relative bg-midnightblue  dark:bg-black dark:bg-opacity-25 bg-opacity-25 z-0 h-[43vh]'>
                      <h1 className='absolute lg:left-20 md:left-10 left-12 text-whitegray lg:bottom-16 md:bottom-16 bottom-14  lg:text-xl md:text-lg text-xl font-bold z-20'>DIGITAL SKILLS TRAINING <span className='bg-carrot lg:p-1 md:p-1 p-0 lg:px-3 md:px-3 px-2 rounded-full'>4</span> WOMEN</h1>
                     ...
                     <img src={down3} className='w-full relative z-10 lg:bottom-36 md:-bottom-36 -bottom-7'/>
                    </div>
                  </div>
