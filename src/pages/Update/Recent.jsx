           ...
           <p data-aos="fade-right" className='font-semibold dark:text-white lg:py-4 md:py-4 mt-24 mb-8 py-1 pt-16 lg:text-4xl md:text-2xl text-2xl text-center opacity-85'>Recent <span className='text-green'>Updates</span></p>
            ...
            <div className='w-full mb-4 lg:px-10 md:px-4 px-2 relative'> 
               ...
               <div className='relative bg-carrot  dark:bg-black dark:bg-opacity-25 bg-opacity-25 z-20 h-[43vh]'>
                <div>
                  <img src={image2} className='w-20 relative lg:top-24 md:top-44 top-24 z-10 left-[55%] border-2 border-green rounded-full object-cover'/>

                  <h1 className='text-2xl text-green relative lg:top-24 md:top-44 top-24 text-center  font-bold z-10'>I YES KATSINA</h1>
                ...
                <img src={down2} className='absolute hidden dark:flex z-0 w-full h-full left-0 right-0 bottom-0  object-cover'/>
                 ...
                 <img src={image3} className='w-full absolute bottom-0 object-cover h-full'/>
                    ...
                    <div className='relative bg-midnightblue  dark:bg-black dark:bg-opacity-25 bg-opacity-25 z-0 h-[43vh]'>
                      <h1 className='absolute lg:left-20 md:left-10 left-16 text-whitegray lg:bottom-16 md:bottom-16 bottom-12  lg:text-xl md:text-lg text-xl font-bold z-20'>DIGITAL SKILLS TRAINING <span className='bg-carrot p-1 px-3 rounded-full'>4</span> WOMEN</h1>
