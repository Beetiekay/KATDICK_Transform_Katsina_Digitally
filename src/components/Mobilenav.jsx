...
const Mobilenav = () => {
  ...
  return (
    <div className='w-[100%] min-h-[100vh]  backdrop-blur-sm relative z-50 lg:px-2 md:px-20 px-7 '>
        ...
        <div className=' w-full mt-10'>
          <img src={image} className='w-full'/>
           <p className='text-white font-serif lg:text-sm md:text-3xl px-2 text-sm'>KATSINA DIRECTORATE OF 
