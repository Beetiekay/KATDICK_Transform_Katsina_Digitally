...
import video from "../assets/videos/katdicks.mp4"
    ...
    <div className='w-[100%] min-h-[100vh]'>
      <div className='grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-4'>
        ...
        {/* Our Focus Areas */}
         ...
         <p  className='font-semibold dark:text-white lg:py-4 md:py-4 py-1 pt-16 lg:text-lg md:text-lg text-sm lg:text-center md:text-center text-start opacity-85'>WHAT WE <span className='text-green'>DO</span></p>
         <div className='flex justify-center mb-4'><h1  className='dark:text-white lg:text-3xl md:text-3xl text-2xl font-semibold lg:text-center md:text-center text-start mb-4'>WE ARE CRAFTING<span className='text-green'> KATSINA'S DIGITAL</span> LEGACY.</h1></div>

          <div className='flex justify-center'><video src={video} controls  className='lg:w-[80%] md:w-[90%] w-fit rounded-2xl lg:h-[70vh] md:h-[50vh] h-[40vh] object-cover border-2 dark:border-green'/></div>

         {/* cards */}
         <div className='py-2 text-lg flex justify-end lg:px-16 md:px-5 px-4 text-green'><Link to={"/more"}>See All</Link></div>
        
         <div className='w-[100%] grid group lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5 lg:px-16 md:px-5 px-4 mb-10'>
            {/* 1 */}
            <div data-aos="flip-right" className='bg-green transition-all ease-in-out duration-1000 hover:scale-105 group-hover:opacity-30 hover:!opacity-100 dark:bg-opacity-65 rounded-lg shadow-md cursor-pointer'>
         ...
         <div className='grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mb-6 gap-6 lg:px-96 md:px-20'>
           <button  className='w-full py-4 border-2 rounded-lg hover:translate-y-1 duration-700 ease-out transition-all bg-green text-white'>
            Request Our Service
           </button>

           <button  className='w-full py-4 border-2 rounded-lg dark:text-white border-green hover:translate-y-1 duration-700 ease-out transition-all hover:bg-green hover:text-white'>
            Other Services
           </button>
         </div>
         <Works/>
