  ...
  return (
    <div className='fixed z-20 lg:top-36 md:top-36  top-28 px-6 lg:right-4 md:right-4 -right-5'>
      <div>
       ...
       <div data-aos="data-zoom-in" className='absolute peer-checked:scale-125 right-16 z-10'><button className='p-2 bg-green border border-white rounded-full'><FaCloudSun className='text-white text-sm'/></button></div>
