...
const Eyeonkt = () => {
  return (
     <div className='w-full min-h-full relative dark:bg-black overflow-hidden'>
        <img src={imagelayer} className='w-full h-[100vh] dark:opacity-15 absolute top-0 hue-rotate-180 object-cover opacity-35'/>
        <div className='w-full h-full relative'>
        <div className='absolute z-20'><Navigation/></div>
          <div className='py-40 lg:h-[99.8vh] md:h-[99.8vh] h-[97vh] bg-black bg-opacity-35'>
            
            <h1 className='lg:text-3xl md:text-3xl lg:mt-0 md:mt-0 mt-10 text-white text-2xl text-center font-semibold mb-14'>HOW INNOVATION DRIVES
            ...
            <div className='grid grid-cols-2 gap-4 lg:w-fit md:w-fit w-[180vw] lg:mb-0 md:mb-0 mb-4'>
                <div data-aos="flip-right" className='bg-white dark:bg-green dark:bg-opacity-20 py-6 px-4 lg:rounded-none md:rounded-none rounded-2xl'>
                    ...
                    <p className='lg:text-2xl dark:text-white md:text-2xl text-lg mb-6'>
                    Using a laptop computer, Smartphone or iPad has become an essential part of everyday life for many people.
                    </p>

                    <p className='lg:text-xl  md:text-xl text-lg lg:rounded-none md:rounded-none rounded-xl bg-green text-white py-2 px-2 lg:w-32 md:w-32 w-28 mb-2'>Louis Smirf</p>
                    <h4 className='text-black opacity-40 dark:text-white'>/ Design Leader – Aqua Group</h4>
                </div>

                <div data-aos="flip-up" className='bg-white dark:bg-green dark:bg-opacity-20 bg-opacity-35 lg:rounded-none md:rounded-none rounded-2xl py-6 px-4'>
                    <p className='text-sm mb-4 text-whitegray'>
                    ...
                    <div className='bg-green lg:rounded-none md:rounded-none rounded-xl text-white px-2 py-2 flex justify-between border-b-4 border-white'>
                        <p className=''>TAGS</p>

                        <a href='https://katdict.ng/case-study-tag/basic/' target='_blank'>Basic</a>
                    </div>

                    <div className='bg-green lg:rounded-none md:rounded-none rounded-xl text-white px-2 py-2 flex justify-between'>
                        <p className=''>SHARE</p>
        ...
        <div className='lg:px-8 md:px-8 px-2 py-6 grid  lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-6 mb-6 border-b-2 relative lg:top-0 md:top-28 top-0 border-green'>
            <div >
            <h1 className='lg:text-3xl md:text-3xl text-2xl mb-4 text-green lg:px-4 md:px-4 px-2 font-semibold'>Requirements</h1>
            <div className='lg:flex md:flex block gap-4'>
                ...
                <p className='text-lg dark:text-white'>The communication between machines of<br/> different kinds sometimes cause troubles and<br/> inaccuratsignal decoding results.</p>
             </div>
            </div>

            <div>
            <h1 className='lg:text-3xl md:text-3xl text-2xl mb-4 text-green g:px-4 md:px-4 px-2 font-semibold'>Our solution</h1>
            <div className='lg:flex md:flex dark:text-white block gap-4'>
         ...
         <div className='lg:px-8 md:px-8 px-2 py-6 grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 relative lg:top-0 md:top-28 top-0  gap-6 mb-6 border-b-2 border-green'>
            ...
            <div className='lg:flex md:flex block gap-4'>
                <FaArrowRight size={25} className='mt-3 lg:rotate-0 md:rotate-0 rotate-90 text-green'/>
                <p className='text-lg dark:text-white'>The potential market for servers and networking equipment development is still unstable and shrinks every year.</p>
             </div>
            </div>

            <div>
            <div className='lg:flex dark:text-white md:flex block gap-4'>
                <MdGppGood size={40} className='mt-3  text-green'/>
         ...
         <div className='lg:px-8 md:px-8 px-2 py-6 relative lg:top-0 md:top-28 top-0 grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-6 mb-6 border-b-2 border-green'>
            <div>
            <div className='lg:flex dark:opacity-70 dark:text-white md:flex block gap-4'>
         ...
         <div className='lg:px-48 md:px-10 px-2 gap-6 grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mb-6'>
            <div  className='relative mb-4'>
              ...
              <div className='dark:text-white peer-checked:text-green peer-checked:rotate-180 top-1 absolute'><FaChevronCircleDown size={22}/></div>
              <div className=' peer-checked:text-green'><h1 className='lg:text-xl dark:text-white md:text-xl text-lg font-semibold px-8'>New Multiple Site Connectivity</h1></div>
              <div className='px-2 py-2 dark:opacity-70 dark:text-white duration-500 hidden peer-checked:block'>
                <p>
            ...
            <div className='relative mb-4'>
              <input type='checkbox' className='w-40 h-6 z-10 cursor-pointer absolute opacity-0 peer transition-transform'/>
              <div className='dark:text-white peer-checked:text-green top-1 peer-checked:rotate-180 absolute'><FaChevronCircleDown size={22}/></div>
              <div className=' dark:text-white peer-checked:text-green'><h1 className='lg:text-xl md:text-xl text-lg font-semibold px-8'>IT Security & Software</h1></div>
              <div className='px-2 py-2 dark:opacity-70 dark:text-white duration-500 hidden peer-checked:block'>
                <p>
            ...
            <div className='relative mb-4'>
              <input type='checkbox' className='w-40 h-6 z-10 cursor-pointer absolute opacity-0 peer transition-transform'/>
              <div className='dark:text-white peer-checked:text-green top-1 peer-checked:rotate-180 absolute'><FaChevronCircleDown size={22}/></div>
              <div className='dark:text-white peer-checked:text-green'><h1 className='lg:text-xl md:text-xl text-lg font-semibold px-8'>Weak Hosted Capability</h1></div>
              <div className='px-2 py-2 dark:opacity-70 dark:text-white duration-500 hidden peer-checked:block'>
                <p>
            ...
            <div className='relative mb-4'>
              ...
              <div className='dark:text-white top-1 peer-checked:text-green peer-checked:rotate-180 absolute'><FaChevronCircleDown size={22}/></div>
              <div className='dark:text-white peer-checked:text-green'><h1 className='lg:text-xl md:text-xl text-lg font-semibold px-8'>Build Internet Network</h1></div>
              <div className='px-2 py-2 dark:opacity-70 dark:text-white duration-500 hidden peer-checked:block'>
                <p>
