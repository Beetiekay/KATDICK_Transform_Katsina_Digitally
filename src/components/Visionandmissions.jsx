...
import image2 from "../assets/hall6.jpg"
import image3 from "../assets/vadoo.jpg"
      ...
      <div>
        ...
        <div className='grid lg:h-fit md:h-[90vh] h-[90vh] lg:grid-cols-2 grid-cols-1 gap-4 px-8 mb-5'>
          ...
          <div className='flex hover:scale-110 duration-500  lg:items-center md:items-start items-start h-[100vh]'>
            ...
            <h1  className='lg:text-center text-start lg:px-0 md:px-2 px-2'>We picture a Katsina where technology isn’t just a tool, but a <span className='text-black font-semibold'>force driving inclusive development,</span> transparent governance, and sustainable progress.</h1>
            </div>
          </div>
        ...
        {/* contents */}
        <div className='grid lg:h-fit md:h-[75vh] h-[90vh] lg:grid-cols-2 md:grid-cols-1 grid-cols-1 gap-4 px-8 mb-5'>
        <div><img src={image2} data-aos="zoom-in" className='rounded-2xl object-cover lg:h-full md:h-full h-[30vh]'/></div>
          <div className='flex items-center '>
          <div className='lg:text-2xl relative lg:top-0 md:top-0 -top-28 hover:scale-110 duration-500 cursor-pointer bg-opacity-80 bg-green py-10 px-4  rounded-2xl text-white md:text-xl text-lg'>
