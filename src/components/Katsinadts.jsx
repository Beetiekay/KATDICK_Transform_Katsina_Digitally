...
import bg from "../assets/hall2.jpg"
...
const Katsinadts = () => {
  return (
    <div className='w-full min-h-[100vh] dark:bg-black relative overflow-hidden'>
       <img src={bg} className='w-full h-[100vh] absolute top-0  object-cover opacity-25'/>
        ...
        <div className='absolute z-20'><Navigation/></div>
         ...
         <div className='py-48 lg:px-8 md:px-8 px-2 '>
          <h1 className='lg:text-3xl md:text-3xl dark:text-white text-green text-2xl text-center font-semibold mb-14'>
          How innovation drives
          research and development
          </h1>
         </div>

          <div className='lg:px-8 md:px-8 px-2 py-6 grid lg:mt-36 md:mt-36 -mt-44 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-6 mb-6 relative lg:top-0 md:top-28 top-0 '>
            <div >
            ...
            <div className='lg:flex md:flex items-center block gap-4'>
              ...
              <div data-aos="flip-right" className='bg-white dark:bg-green dark:bg-opacity-15 py-6 px-4 lg:rounded-none md:roundedrounded-2xl'>
                ...
                <p className='lg:text-xl dark:text-white md:text-xl text-lg lg:rounded-none md:rounded-none rounded-xl bg-green text-white py-2 px-2 lg:w-44 md:w-44 w-28 mb-2'>
                Maggie Strickland</p>
                <h4 className='text-black dark:text-white opacity-40'>/ Group Chief Information – Aqua Group</h4>
            </div>
              <div data-aos="flip-up" className='bg-white dark:bg-green dark:bg-opacity-40 bg-opacity-35 lg:rounded-none md:roundedrounded-2xl py-6 px-4'>
              ...
              <div>
               ...
               <div>
                  ...
                  <div  className='relative mb-4'>
                     ...
                     <div className='dark:text-white peer-checked:text-green'><h1 className='lg:text-xl md:text-xl text-lg font-semibold px-8'>New Multiple Site Connectivity</h1></div>
