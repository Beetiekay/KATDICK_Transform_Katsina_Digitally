  ...
  return (
    <div className='py-6 dark:bg-black'>
      ...
      <div className='py-2 text-lg flex justify-start lg:px-8 md:px-5 px-4 text-green'><Link to={"/"}>Back</Link></div>
        ...
        {/* 1 */}
        <div data-aos="flip-left" className='bg-green dark:bg-opacity-65 rounded-lg shadow-md cursor-pointer'>
        ...
        {/* 4 */}
        <div data-aos="flip-right" className='bg-green dark:bg-opacity-65 rounded-lg shadow-md cursor-pointer'>
